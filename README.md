...
<img src="assets/header_banner.jpg" alt="Nemanja Djuric Banner" width="100%" style="border-radius: 12px; margin-bottom: 20px;" />
...
<p>
  ...
  <img src="https://img.shields.io/badge/CI%2FCD-0284c7?style=flat-square&logo=git&logoColor=white" alt="CI/CD" />
...
### ⚙️ [PHP-FPM Config](https://github.com/nemke82/php-fpm-config)
...
* **[Magento Doctor](https://github.com/nemke82/magento-doctor)** — Rust-powered static analysis and forensics.
* **[Magento2Gitpod](https://github.com/nemke82/magento2gitpod)** — Ephemeral cloud-based Magento development stack.
...
1. **[magento-doctor](https://github.com/nemke82/magento-doctor)** — Deep diagnostics and performance forensics for Magento 2 in Rust.
2. **[meshguard](https://github.com/nemke82/meshguard)** — Encrypted peer-to-peer messaging over Meshtastic in Rust.
3. **[mailshrink](https://github.com/nemke82/mailshrink)** — Storage reclamation for large Dovecot Maildir servers in Go.
4. **[magento2gitpod](https://github.com/nemke82/magento2gitpod)** — Preconfigured cloud development environments.
5. **[sqlscale](https://github.com/nemke82/sqlscale)** — On-premise Database-as-a-Service on Kubernetes/OpenEBS.
6. **[php-fpm-config](https://github.com/nemke82/php-fpm-config)** — Resource-aware PHP-FPM configuration automation.
...
<p align="center">
  <a href="https://nemanja.io">
    <img src="https://img.shields.io/badge/Website-nemanja.io-0284c7?style=for-the-badge&logo=google-chrome&logoColor=white" alt="Website" />
  </a>
  &nbsp;
  <a href="https://github.com/nemke82">
...
<div align="center">
  <sub><i>"I build software for operating software."</i></sub>
</div>
